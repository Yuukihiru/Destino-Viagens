$(document).ready(function() {
    ...
    $(document).ready(function() {
        // Inicializar seletor de datas com opções personalizadas e localização para português
        $(".date-picker").datepicker({
          // Adicionar classes de estilo personalizadas
          beforeShow: function(input, inst) {
            $(inst.dpDiv).addClass("custom-datepicker");
          },
          // Definir opções de localização para português
          dateFormat: "dd/mm/yy",
   ...
   $(window).on("load", function() {
    ...
    var map = L.map(mapElement).setView([-6.4768, -35.4339], 15);
    ...
    // Exemplo de código para remover o marcador
